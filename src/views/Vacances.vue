<template>
  <div class="vacances">
    <!-- Hero Section -->
    <HeroSearch :title="pageTitle" :text="pageText" active="vacances" bg="vacances" :extras="data?.extras || {}"
      :extra="data?.extra || []" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div class="flex justify-end items-center">
            <PageImage :page="data.page" :type-id="data?.type_id" :types="data?.types || []"
              ...
              default-image="/images/main_pages/Annonces-de-locations-de-vacances-au-Maroc.webp"
    ...
    <FooterLinks
      ...
      :category-id="data?.category_id || 4"
      :ville="data?.ville || ''"
