...
<template>
  <div>
      ...
      <div class="relative py-16 w-full z-10">
        <div class="max-w-3xl mx-auto flex flex-col items-center justify-center px-4">
          ...
          <form @submit.prevent="handleSearch"
            ...
            <input v-model="searchInput" type="text" :placeholder="t('decouvrezMaroc.filter.hero.search_placeholder')"
              class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none text-gray-900 bg-white"
    ...
    <div class="bg-white border-b border-gray-200 text-center text-gray-600">
      <div
        class="mx-auto text-center w-full h-full md:max-w-6xl max-w-full overflow-x-auto small-scrollbar px-4 flex items-center justify-center whitespace-nowrap relative">
    ...
    <section class="w-full py-8 bg-gray-50">
      <div class="container mx-auto px-36">
        ...
        <div v-else class="flex flex-wrap -mx-3">
          <div v-for="result in decouvrez" :key="result.id" @click.prevent="goToArticle(result.slug)"
